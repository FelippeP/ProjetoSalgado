...
<body>
    <img src="banner-maculino.png" class="img-fluid d" > <br>  <br> 
...
<div class="card-deck">
  <div class="card">
      <img class="card-img-top" src="masculino1.png" alt="Imagem de capa do card">
    <div class="card-body" >
    ...
    <div class="card">
        <img class="card-img-top" src="masculino2.png"  alt="Imagem de capa do card">
    <div class="card-body">
  ...
  <div class="card">
      <img class="card-img-top" src="masculino3.png" alt="Imagem de capa do card">
    <div class="card-body">
...
<div class="card-deck">
  <div class="card">
      <img class="card-img-top" src="masculino4.png" alt="Imagem de capa do card">
    <div class="card-body" >
      <div class="card-header">TREINE EM CASA </div> 
      <p class="card-text"> <br>Confira agora incríveis peças para treino em casa. ATÉ 50% OFF <br>  <br><a href="#" role="button" class="btn btn-outline-primary">COMPRAR</a>
    </div> 
